...
export default {
  ...
  created() {
    axios.get('http://192.168.11.132:1314/api/type').then(res => {
  ...
  methods: {
    ...
    removebtn(id, i) {
      ...
      if (confirm('确认删除吗')) {
        ...
        axios
          .post('http://192.168.11.132:1314/api/type', { id: id })
          .then(res => {
            console.log(res)
          })
      }
    ...
    wancheng() {
      ...
      axios
        .post('http://192.168.11.132:1314/api/type/add', { name: this.name })
        .then(res => {
          console.log(res)
          this.name = ''
          this.show = !this.show
    ...
    chenge2(id, index) {
      ...
      if (id === undefined) {
        axios
          .post('http://192.168.11.132:1314/api/type/add', {
        ...
        if (confirm('确认修改吗')) {
          axios
            .put('http://192.168.11.132:1314/api/type', {
              id: id,
              name: this.productClass[index].name
            })
            .then(res => {
